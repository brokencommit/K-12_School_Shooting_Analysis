...
mask = (totalDeaths['DateTime'] >= '2009-01') & (totalDeaths['DateTime'] <= '2020-03')
totalDeaths = totalDeaths.loc[mask]

ax = totalDeaths.plot( x='DateTime', y='Total Injured/Killed Victims' )
...
ax.set_xlabel( 'DateTime', size=30 )
ax.set_ylabel( 'Total Injured/Killed Victims', size=30 )
